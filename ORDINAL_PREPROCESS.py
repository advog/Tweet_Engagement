...
def main():
    ...
    plt.hist(Y1, 200, histtype='bar', facecolor='blue')

    plt.show()

    Y1 = np.array(Y1)
    Y1P1 = np.percentile(Y1,50)
    Y1P2 = np.percentile(Y1, 70)
    Y1P3 = np.percentile(Y1, 80)
    Y1P4 = np.percentile(Y1, 90)
    Y1P5 = np.percentile(Y1, 95)

    Y2 = np.array(Y2)
    Y2P1 = np.percentile(Y2, 50)
    Y2P2 = np.percentile(Y2, 70)
    Y2P3 = np.percentile(Y2, 80)
    Y2P4 = np.percentile(Y2, 90)
    Y2P5 = np.percentile(Y2, 95)
